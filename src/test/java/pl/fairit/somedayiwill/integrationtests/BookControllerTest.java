...
class BookControllerTest {
    ...
    public void shouldReturnListOfUsersBooksWhenGetAllPerformed() {
        ...
        var booksToReturn = new Books(List.of(bookToReturn));
    ...
    public void shouldReturnBookWhenGetBookByIdPerformed() {
        ...
        Mockito.when(booksService.getUsersBook(ArgumentMatchers.anyLong(), ArgumentMatchers.anyLong())).thenReturn(bookToReturn);
        var response = given()
                .header("Authorization", "Bearer " + token)
                .contentType(ContentType.JSON)
